...
class CanvasWebgl{
  ...
  addEventListeners(){
    ...
    window.addEventListener('resize', () => {
      ...
      // Update Smooth scroll dimensions
      this.smoothScroll.onWindowResize()
    })
...
class MeshItem{
  ...
  setDimensions(){
    const {width, height, top, left} = this.src.parentElement.getBoundingClientRect();
    ...
    this.mesh = new THREE.Mesh(
      ...
      new THREE.ShaderMaterial({
          ...
          uniforms: {
            ...
            uTextureSize: {value: new THREE.Vector2(this.src.offsetWidth, this.src.offsetHeight)},
            uPlaneResolution: {value: new THREE.Vector2(this.src.parentElement.offsetWidth, this.src.parentElement.offsetHeight)}
          },
          vertexShader: vertex,
  ...
  onWindowResize(){
    this.mesh.material.uniforms.uTextureSize.value.set(this.src.offsetWidth, this.src.offsetHeight);
    this.mesh.material.uniforms.uPlaneResolution.value.set(this.src.parentElement.offsetWidth, this.src.parentElement.offsetHeight);
  }
